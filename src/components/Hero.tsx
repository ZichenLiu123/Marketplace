    ...
    <div className="relative min-h-[90vh] flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div 
          ...
          style={{ 
            // Replace with your own image URL here
        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className={`transition-all duration-700 delay-500 ${isLoaded ? 'opacity-100 transform translate-y-0' : 'opacity-0 transform translate-y-10'}`}>
            <div className="flex flex-col md:flex-row max-w-2xl mx-auto space-y-4 md:space-y-0 md:space-x-4">
              ...
              <Button className="h-12 px-8 bg-toronto-gold text-toronto-dark hover:bg-toronto-gold/90" asChild>
          ...
          <div className={`mt-16 transition-all duration-700 delay-700 ${isLoaded ? 'opacity-100 transform translate-y-0' : 'opacity-0 transform translate-y-10'}`}>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8 max-w-3xl mx-auto">
              {['Textbooks', 'Electronics', 'Furniture', 'Services'].map((category, index) => (
                <Link
                  key={category}
