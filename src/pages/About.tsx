      ...
      <main className="flex-grow">
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
              <div className="text-center">
                <div className="rounded-full w-32 h-32 bg-gray-200 mx-auto mb-4"></div>
                <h3 className="text-xl font-bold">Zach Liu</h3>
                <p className="text-gray-600">Founder & CEO</p>
                <p className="text-gray-500 text-sm mt-2">Industrial Engineering '26</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-500 text-sm mt-2">MBA Rotman '23</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-500 text-sm mt-2">Engineering '25</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 bg-toronto-dark text-white">
          <div className="container mx-auto px-4 text-center">
            ...
            <a 
              href="mailto:contact@uoftmarket.com" 
              className="inline-block bg-toronto-gold text-toronto-dark font-medium px-6 py-3 rounded-md hover:bg-toronto-gold/90 transition-colors"
            >
              Contact Us
            </a>
          </div>
